...
var GameMap = (function () {
    ...
    GameMap.prototype.loadMap = function (mapName, startingPosition, startingElevation, loadedCallback) {
        ...
        if (Config.engine.doSaveDirtyMaps && this.name !== null) {
            console.log("[Main] Serializing map ".concat(this.name, " and committing to dirty map cache"));
            dirtyMapCache[this.name] = this.serialize();
        }
        if (mapName in dirtyMapCache) {
            console.log("[Main] Loading map ".concat(mapName, " from dirty map cache"));
            ...
            console.log("[Main] Loading map ".concat(mapName, " from clean load"));
