...
function disassemble(intfile, reader) {
    ...
    function emitOp(opcode, offset, args, t) {
        ...
        var p = "";
        if (opcode === 0x9001)
            p = " (\"".concat(intfile.strings[args[0]], "\" | ").concat(intfile.identifiers[args[0]], ")");
        emit("0x".concat(offset.toString(16), ": ").concat(opcode.toString(16), " ").concat(opNames[opcode], " ").concat(sargs) + p, t);
    }
    function disasm(t) {
        if (t === void 0) { t = 0; }
