...
(function (Worldmap) {
    ...
    function parseWorldmap(data) {
        ...
        return { squares: squares, encounterTables: encounterTables, encounterGroups: encounterGroups, encounterRates: encounterRates, terrainSpeed: parseKeyed(ini.Data.terrain_types) };
    }
    ...
    function setSquareStateAt(squarePos, newState, seeAdjacent) {
        ...
        var $square = document.querySelector("div.worldmapSquare[square-x='".concat(squarePos.x, "'][square-y='").concat(squarePos.y, "']"));
