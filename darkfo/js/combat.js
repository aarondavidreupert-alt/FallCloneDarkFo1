...
var Combat = (function () {
    ...
    Combat.prototype.getDamageDone = function (obj, target, critModifer) {
        ...
        console.log("RD: ".concat(RD, " | CM: ").concat(CM, " | ADR: ").concat(ADR, " | ADT: ").concat(ADT, " | Base Dmg: ").concat(baseDamage, " Adj Dmg: ").concat(adjustedDamage, " | Type: ").concat(damageType));
    ...
    Combat.prototype.doAITurn = function (obj, idx, depth) {
        if (depth > Config.combat.maxAIDepth) {
            console.warn("Bailing out of ".concat(depth, "-deep AI turn recursion"));
